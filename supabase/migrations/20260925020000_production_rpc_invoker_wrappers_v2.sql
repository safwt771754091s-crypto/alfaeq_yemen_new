...
revoke execute on function private.redeem_merchant_invite_internal(text) from public,anon,authenticated;
revoke execute on function private.transition_order_internal(text,text,text) from public,anon,authenticated;
revoke execute on function private.wallet_credit_internal(numeric,text,text,text,text) from public,anon,authenticated;
revoke execute on function private.wallet_debit_internal(numeric,text,text,text,text) from public,anon,authenticated;
