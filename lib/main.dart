                    ...
                    trailing: ElevatedButton(
                      ...
                      onPressed: () {
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(content: Text('تمت إضافة (${prod['name']}) إلى السلة بنجاح')),
                        );
                      },
...
class _CartScreenState extends State<CartScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('سلة المشتريات والدفع', style: TextStyle(color: Colors.white, fontSize: 14)), backgroundColor: const Color(0xFF1A365D)),
      body: CartModel.items.isEmpty
          ? const Center(child: Text('السلة فارغة حالياً. أضف منتجات وابدأ التسوق!', style: TextStyle(color: Colors.grey)))
          : Column(
              children: [
                Expanded(
                ...
                Container(
                  ...
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Text('الإجمالي: ${CartModel.totalAmount} ر.ي', style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 14)),
                      ElevatedButton(
                        ...
                        onPressed: () {
                          showDialog(
                            ...
                            builder: (context) => AlertDialog(
                              ...
                              content: Text('تم خصم مبلغ ${CartModel.totalAmount} ر.ي من محفظة الفائق بنجاح وإرسال الطلب للمتجر والمندوب!'),
                              actions: [
                                TextButton(
                                  onPressed: () {
                                    setState(() {
...
class WalletScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('محفظة الفائق وامتيازات التاجر', style: TextStyle(color: Colors.white, fontSize: 14)), backgroundColor: const Color(0xFF1A365D)),
      body: Padding(
        padding: const EdgeInsets.all(16),
        child: Column(
          children: [
            ...
            const ListTile(leading: Icon(Icons.verified, color: Colors.green), title: Text('حساب تاجر معتمد'), subtitle: Text('تم تفعيل امتيازات المنصة الشاملة')),
          ],
        ),
      ),
    );
...
class TrackingMapScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('تتبع الرحلة وخط السير الحي', style: TextStyle(color: Colors.white, fontSize: 14)), backgroundColor: const Color(0xFF1A365D)),
      body: Stack(
        children: [
          Container(
...
class LoginScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('تسجيل الدخول وإدارة الصلاحيات', style: TextStyle(color: Colors.white, fontSize: 14)), backgroundColor: const Color(0xFF1A365D)),
      body: Padding(
        padding: const EdgeInsets.all(16),
        child: Column(
          children: [
