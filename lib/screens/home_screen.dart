...
class _HomeScreenState extends State<HomeScreen> {
            ...
            actions: [
              ...
              FutureBuilder<AppRole>(
                ...
                builder: (context, snapshot) {
                  final isAdmin = snapshot.data == AppRole.admin ||
                      snapshot.data == AppRole.manager;
                  ...
                  return PopupMenuButton<String>(
                    ...
                    itemBuilder: (_) => const [
                      PopupMenuItem(
                        value: 'admin',
                        child: Text('لوحة الإدارة والذكاء الاصطناعي'),
                      ),
                      PopupMenuItem(
                        value: 'logout',
                        child: Text('تسجيل الخروج'),
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    const Text(
                      'أفضل المنتجات والخدمات في مكان واحد',
                      style: TextStyle(
  ...
  Widget _buildServicesGrid(BuildContext context) {
    final services = [
      ...
      },
      {
        ...
        'title': 'الصيدليات والأدوية',
        'color': Colors.teal,
      },
      {
        'icon': Icons.local_shipping,
        'title': 'الشحن بين المدن',
        'color': Colors.brown,
      },
      {
  ...
  Widget _buildSmartTripCard(BuildContext context) => Container(
          ...
          children: [
            const Row(
              children: [
                ...
                SizedBox(width: 8),
                Text(
                  'رحلتك القادمة: مأرب ➔ عدن',
                  style: TextStyle(fontWeight: FontWeight.bold),
                ),
              ],
            ),
            const SizedBox(height: 8),
            const Text('تتبع خط السير وخدمات السفر من مكان واحد.'),
            ...
            SizedBox(
              ...
              child: ElevatedButton.icon(
                ...
                label: const Text('تتبع خط السير'),
              ),
            ),
          ],
        ),
